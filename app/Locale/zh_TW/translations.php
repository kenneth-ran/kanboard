...
return array(
    ...
    'Unable to remove this sub-task.' => '無法删除此子任務',
    ...
    'view the task on Kanboard' => '檢視看板中的此任務',
    'Public access' => '公開瀏覽',
    'Disable public access' => '停用公開瀏覽',
    'Enable public access' => '啟用公開瀏覽',
    'Public access disabled' => '已停用公開瀏覽',
    ...
    'Assigned to %s with an estimate of %s/%sh' => '指派给 %s，預估需要 %s/%s 小時',
    'Not assigned, estimate of %sh' => '尚未指派，預估需要 %s 小時',
    ...
    'Frequency in second (60 seconds by default)' => '頻率,單位為秒(預設60秒)',
    'Frequency in second (0 to disable this feature, 10 seconds by default)' => '頻率,單位為秒(若設為0為停用此功能，預設10秒)',
    ...
    'Start date' => '開始日期',
    'Time estimated' => '預計時間',
    'There is nothing assigned to you.' => '目前尚無任務指派给你。',
    'My tasks' => '我的任務',
    ...
    'Column removed successfully.' => '欄位删除成功。',
    'Not enough data to show the graph.' => '資料不足以致無法顯示圖表。',
    'Previous' => '上一頁',
    ...
    'Exports' => '匯出',
    'This export contains the number of tasks per column grouped per day.' => '此匯出包含每列的任務數，按日分组',
    ...
    'Estimated hours: ' => '預估時數',
    'Actual hours: ' => '實際時數',
    'Hours Spent' => '花費時數',
    'Hours Estimated' => '預估時數',
    'Estimated Time' => '預估時間',
    'Actual Time' => '實際時間',
    ...
    'Do you really want to remove this custom filter: "%s"?' => '你確定要移除這個自訂過濾器："%s"？',
    'Remove a custom filter' => '移除自訂過濾器',
    'User activated successfully.' => '帳號已啟用。',
    'Unable to enable this user.' => '無法啟用帳號。',
    'User disabled successfully.' => '帳號已停用。',
    'Unable to disable this user.' => '無法停用帳號。',
    ...
    'Two Factor' => '二階段驗證',
    'Disable user' => '停用帳號',
    'Do you really want to disable this user: "%s"?' => '你確定要停用帳號："%s"？',
    'Enable user' => '啟用帳號',
    ...
    'Creator Name' => '建立人名稱',
    'Time spent and estimated' => '時間花費與預估',
    'Move position' => '移動位置',
    'Move task to another position on the board' => '移動任務到另一個位置',
    'Insert before this task' => '插入在此任務前',
    'Insert after this task' => '插入在此任務後',
    'Unlock this user' => '解鎖帳號',
    'Custom Project Roles' => '自訂專案角色',
    ...
    'Your custom project role has been created successfully.' => '自訂項目角色建立成功。',
    'Unable to create custom project role.' => '無法删除自訂專案角色。',
    'Your custom project role has been updated successfully.' => '自訂项目角色更新成功。',
    'Unable to update custom project role.' => '無法更新自訂專案角色。',
    'Custom project role removed successfully.' => '删除自訂專案角色成功。',
    ...
    'Remove a custom role' => '删除自訂角色',
    'Do you really want to remove this custom role: "%s"? All people assigned to this role will become project member.' => '你真的要删除這個自訂角色："%s"？目前角色下的成員將轉成普通專案成員。',
    'There is no custom role for this project.' => '目前專案没有自訂角色',
    'New project restriction for the role "%s"' => '给角色"%s"新建專案限制',
    'Restriction' => '限制',
    'Remove a project restriction' => '移除專案限制',
    'Do you really want to remove this project restriction: "%s"?' => '你確定要删除專案限制："%s"？',
    ...
    'The project email is optional and could be used by several plugins.' => '專案郵件位址是選填，僅使用於數個外掛擴充元件。',
    'The project email must be unique across all projects' => '此專案郵件地址必須是全域唯一。',
    'The email configuration has been disabled by the administrator.' => '郵件設定已被管理員禁用。',
    ...
    'Another category with the same name exists in this project' => '此專案已存在其它同名的分類。',
    'Comment sent by email successfully.' => '評論已經由郵件傳送成功。',
    'Sent by email to "%s" (%s)' => '已傳送郵件到 "%s"',
    'Unable to read uploaded file.' => '無法讀取已上傳檔案。',
    'Database uploaded successfully.' => '資料庫已上傳成功。',
    'Task sent by email successfully.' => '任務經由郵件傳送成功。',
    'There is no category in this project.' => '目前專案没有分類。',
    'Send by email' => '發送郵件',
    'Create and send a comment by email' => '通過電子郵件建立和發送評論',
    'Subject' => '主旨',
    'Upload the database' => '上傳資料庫',
    'You could upload the previously downloaded Sqlite database (Gzip format).' => '你能先上傳之前下載的sqlite資料庫(Gzip格式)。',
    'Database file' => '資料庫檔案',
    'Upload' => '上傳',
    'Your project must have at least one active swimlane.' => '專案必須包含至少一個活躍泳道。',
    'Project: %s' => '專案: %s',
    'Automatic action not found: "%s"' => '找不到自動化行為:"%s"',
    '%d projects' => '%d 專案',
    '%d project' => '%d 專案',
    ...
    '%d task' => '%d 任務',
    'Task ID' => '任務編號',
    'Assign automatically a color when due date is expired' => '當任務過期時，自動標註顏色',
    'Total score in this column across all swimlanes' => '該欄目所有里程碑上的總分',
    // 'HRK - Kuna' => '',
    // 'ARS - Argentine Peso' => '',
    // 'COP - Colombian Peso' => '',
    '%d groups' => '%d 群組',
    ...
    'Hide subtasks' => '顯示子任務',
    'Show subtasks' => '隱藏子任務',
    'Authentication Parameters' => '驗證參數',
    'API Access' => 'API授權',
    'No users found.' => '找不到使用者。 ',
    'User ID' => '使用者ID',
    'Notifications are activated' => '通知已啟用',
    'Notifications are disabled' => '通知已禁用',
    'User disabled' => '使用者已停用',
    '%d notifications' => '%d 通知',
    '%d notification' => '%d 通知',
    'There is no external integration installed.' => '目前沒有外部整合安裝。 ',
    'You are not allowed to update tasks assigned to someone else.' => '你沒有權限更新任務指派。 ',
    'You are not allowed to change the assignee.' => '你沒有權限更改目前代理人。 ',
    'Task suppression is not permitted' => '任務抑制是不允許的',
    'Changing assignee is not permitted' => '更改代理人是不允許的',
    'Update only assigned tasks is permitted' => '只允許更新已受理任務',
    'Only for tasks assigned to the current user' => '只作用於目前用戶已代理任務',
    'My projects' => '我的專案',
    ...
    'Subtask Title' => '子任務標題',
    'Add a subtask and activate the timer when moving a task to another column' => '當移動任務到別的欄目組時，增加子任務並開始計時。',
    'days' => '天',
    'minutes' => '分',
    'seconds' => '秒',
    'Assign automatically a color when preset start date is reached' => '當到達預設起始日期時，自動指派顏色',
    'Move the task to another column once a predefined start date is reached' => '當到達預定起始日期時，移動任務到另一欄目',
    'This task is now linked to the task %s with the relation "%s"' => '該任務與任務：%s 已建立"%s"關聯。',
    'The link with the relation "%s" to the task %s has been removed' => '該任務與任務：%s 已解除"%s"關聯。',
    'Custom Filter:' => '自訂過濾',
